...
class Application(tk.Frame):
    def __init__(self, master):
        ...
        self.master = master
        master.title('Supermarket Inventory')
        # Width height
    ...
    def create_widgets(self):
        ...
        self.part_label = tk.Label(
            self.master, text='Product', font=('bold', 14), pady=20, bg = 'purple')
        ...
        self.customer_label = tk.Label(
            self.master, text='Common name', font=('bold', 14), bg = 'purple')
        ...
        self.retailer_label = tk.Label(
            self.master, text='Amount in stock', font=('bold', 14), bg = 'purple')
        ...
        self.price_label = tk.Label(
            self.master, text='Price', font=('bold', 14), bg = 'purple')
        ...
        self.add_btn = tk.Button(
            self.master, text="Add Product", width=12, command=self.add_item)
        self.add_btn.grid(row=2, column=0, pady=20)

        self.remove_btn = tk.Button(
            self.master, text="Remove Product", width=12, command=self.remove_item)
        self.remove_btn.grid(row=2, column=1)

        self.update_btn = tk.Button(
            self.master, text="Update Product", width=12, command=self.update_item)
        self.update_btn.grid(row=2, column=2)

        self.exit_btn = tk.Button(
            self.master, text="Clear Product", width=12, command=self.clear_text)
